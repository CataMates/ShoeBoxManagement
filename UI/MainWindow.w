...
&Scoped-Define ENABLED-OBJECTS BUTTON-5 BUTTON-6 BUTTON-7 BUTTON-8 
...
DEFINE FRAME DEFAULT-FRAME
     BUTTON-5 AT ROW 7.19 COL 9 WIDGET-ID 6
     BUTTON-6 AT ROW 7.19 COL 34 WIDGET-ID 8
     BUTTON-7 AT ROW 7.19 COL 61 WIDGET-ID 10
     BUTTON-8 AT ROW 7.19 COL 89 WIDGET-ID 12
     "WELCOME TO SHOEBOX MANAGEMENT" VIEW-AS TEXT
          SIZE 80 BY 3.33 AT ROW 1.71 COL 17 WIDGET-ID 14
          FONT 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 110.2 BY 12.43 WIDGET-ID 100.
...
/*              LEAVE.                                                                      */
/*            IF SELECT-1:LIST-ITEMS IN FRAME DEFAULT-FRAME = ? THEN DO:                    */
/*                SELECT-1:LIST-ITEMS = personTableHandle::Name.                            */
/*            END.                                                                          */
/*            ELSE DO:                                                                      */
/*                SELECT-1:LIST-ITEMS = SELECT-1:LIST-ITEMS + "," + personTableHandle::Name.*/
/*            END.                                                                          */
/*        END.                                                                              */
/*END.                                                                                      */
...
ON CHOOSE OF BUTTON-6 DO:
    RUN RequestWindow.w.
END.

ON CHOOSE OF BUTTON-7 DO:
    RUN DonationWin.w.
END.
ON CHOOSE OF BUTTON-8 DO:
    RUN ShoeBoxWin.w.
END.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-5 BUTTON-6 BUTTON-7 BUTTON-8 
